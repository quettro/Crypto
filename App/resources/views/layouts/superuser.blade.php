...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        @vite(['resources/css/app.css', 'resources/js/superuser.js'])
    </head>
    <body class="flex flex-col">
        <div class="flex-[0_0_auto]">
            <div class="w-[100%] max-w-screen-xl mx-auto px-3 py-6">
                @include('layouts.superuser-navigation')
            </div>
        </div>

        <div class="flex-[1_0_auto]">
            <div class="w-[100%] max-w-screen-xl mx-auto px-3 py-6">
                @include('layouts.superuser-content')
            </div>
        </div>
