...
@section('content')
    <main class="flex flex-col min-h-[100%]">
        <section class="flex-[0_0_auto]">
            <div class="py-6 flex justify-center">
                <a href="{{ route('welcome') }}" title="{{ config('app.name') }}">
                    <img src="{{ Vite::asset('resources/images/logotype.png') }}?v=0.1" class="object-contain object-center" width="38px" height="38px" alt="{{ config('app.name') }}">
                </a>
            </div>
        </section>
